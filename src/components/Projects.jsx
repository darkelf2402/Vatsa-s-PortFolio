  ...
  return (
    <div className=''>
      ...
      <div className='flex-col ml-2'>
        ...
        <div className='flex flex-col mt-11 sm:flex-row sm:items-center'>
          ...
          <div className='text-center'>
            <a href="https://65531ce6dc3c12254adf2f06--relaxed-wisp-3b96f2.netlify.app/" target="_blank">
              <img src={hoobank} className='h-[108px] rounded-md w-[252px] mx-auto mb-3 transition duration-300 hover:opacity-70 ' alt="hoobank" />
            </a>
          </div>
        </div>

        <div className='flex flex-col mt-7 sm:flex-row sm:items-center'>
          <div className='text-center sm:mr-5'>
            <a href="https://www.youtube.com/watch?v=IH7MeH0iXrU" target="_blank">
              <img src={chads} className='h-[108px] rounded-md w-[252px] mx-auto mb-3 transition duration-300 hover:opacity-70 ' alt="hoobank" />
            </a>
          </div>
