...
const CustomCard = ({ icon, iconSize, title, description }) => (
  <div className='bg-gray-100 w-full sm:w-[260px] h-[160px] m-2 rounded-[4px]'>
    {icon && React.cloneElement(icon, { className: `mt-7 ${icon.props.className}`, style: { fontSize: iconSize} })}
    <p className="text-center font-bold mt-3 text-green-700">{title}</p>
...
const Services = () => {
  return(
    ...
    <div>
      ...
      <div className='flex   flex-col items-center md:flex-row   mt-[38px] max-w-[530px]'>
        <div>
            <CustomCard
